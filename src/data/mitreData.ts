...
export const tactics: Tactic[] = [
  {
    ...
    techniques: [
      ...
      { id: 'T1091', name: 'Replication via Removable Media' },
      { id: 'T1195', name: 'Supply Chain Compromise' },
      { id: 'T1195.001', name: 'Compromise Software Deps & Dev Tools' },
  ...
  },
  {
    ...
    techniques: [
      ...
      { id: 'T1059.012', name: 'Hypervisor CLI' },
      { id: 'T1059.013', name: 'Container CLI/API' },
      { id: 'T1609', name: 'Container Admin Command' },
      { id: 'T1610', name: 'Deploy Container' },
      { id: 'T1675', name: 'ESXi Administration Command' },
      { id: 'T1203', name: 'Exploitation for Client Execution' },
      { id: 'T1674', name: 'Input Injection' },
      ...
      { id: 'T1677', name: 'Poisoned Pipeline Execution' },
      ...
      { id: 'T1569.003', name: 'Systemctl' },
      { id: 'T1204', name: 'User Execution' },
      { id: 'T1204.001', name: 'Malicious Link' },
      { id: 'T1204.002', name: 'Malicious File' },
      { id: 'T1204.003', name: 'Malicious Image' },
      { id: 'T1204.004', name: 'Malicious Copy and Paste' },
      { id: 'T1204.005', name: 'Malicious Library' },
      { id: 'T1047', name: 'WMI' },
    ],
  },
  {
    ...
    techniques: [
      ...
      { id: 'T1546.003', name: 'WMI Event Subscription' },
      { id: 'T1546.004', name: 'Unix Shell Config Modification' },
      ...
      { id: 'T1546.015', name: 'COM Hijacking' },
      { id: 'T1546.016', name: 'Installer Packages' },
      { id: 'T1546.017', name: 'Udev Rules' },
      { id: 'T1546.018', name: 'Python Startup Hooks' },
      { id: 'T1668', name: 'Exclusive Control' },
      { id: 'T1133', name: 'External Remote Services' },
      { id: 'T1574', name: 'Hijack Execution Flow' },
      { id: 'T1574.001', name: 'DLL' },
      ...
      { id: 'T1574.007', name: 'Path Interception by PATH Env Variable' },
      ...
      { id: 'T1505.006', name: 'vSphere Installation Bundles' },
      { id: 'T1176', name: 'Software Extensions' },
      { id: 'T1176.001', name: 'Browser Extensions' },
      { id: 'T1176.002', name: 'IDE Extensions' },
  ...
  },
  {
    ...
    techniques: [
      ...
      { id: 'T1543.004', name: 'Launch Daemon' },
      { id: 'T1543.005', name: 'Container Service' },
      { id: 'T1484', name: 'Domain/Tenant Policy Modification' },
      ...
      { id: 'T1055.001', name: 'DLL Injection' },
      ...
      { id: 'T1055.013', name: 'Process Doppelganging' },
  ...
  },
  {
    ...
    techniques: [
      ...
      { id: 'T1222', name: 'File/Directory Permissions Mod' },
      { id: 'T1222.001', name: 'Windows Permissions Mod' },
      { id: 'T1222.002', name: 'Linux/Mac Permissions Mod' },
      ...
      { id: 'T1564.012', name: 'File/Path Exclusions' },
      { id: 'T1564.013', name: 'Bind Mounts' },
      { id: 'T1564.014', name: 'Extended Attributes' },
      { id: 'T1574', name: 'Hijack Execution Flow' },
      ...
      { id: 'T1562.013', name: 'Disable or Modify Network Device Firewall' },
      { id: 'T1656', name: 'Impersonation' },
      { id: 'T1070', name: 'Indicator Removal' },
      { id: 'T1070.001', name: 'Clear Windows Event Logs' },
      { id: 'T1070.002', name: 'Clear Linux/Mac System Logs' },
      ...
      { id: 'T1070.010', name: 'Relocate Malware' },
      ...
      { id: 'T1036.003', name: 'Rename Legitimate Utilities' },
      ...
      { id: 'T1036.010', name: 'Masquerade Account Name' },
      { id: 'T1036.011', name: 'Overwrite Process Arguments' },
      { id: 'T1036.012', name: 'Browser Fingerprint' },
      ...
      { id: 'T1599.001', name: 'NAT Traversal' },
      ...
      { id: 'T1027.013', name: 'Encrypted/Encoded File' },
      { id: 'T1027.014', name: 'Polymorphic Code' },
      { id: 'T1027.015', name: 'Compression' },
      { id: 'T1027.016', name: 'Junk Code Insertion' },
      { id: 'T1027.017', name: 'SVG Smuggling' },
      ...
      { id: 'T1218.015', name: 'Electron Applications' },
      ...
      { id: 'T1127.002', name: 'ClickOnce' },
      { id: 'T1127.003', name: 'JamPlus' },
      ...
      { id: 'T1497.003', name: 'Time Based Checks' },
      ...
      { id: 'T1556', name: 'Modify Auth Process' },
      { id: 'T1666', name: 'Modify Cloud Resource Hierarchy' },
      { id: 'T1672', name: 'Email Spoofing' },
      { id: 'T1678', name: 'Delay Execution' },
      { id: 'T1679', name: 'Selective Exclusion' },
    ],
  },
  {
    id: 'TA0006',
    ...
    techniques: [
      ...
      { id: 'T1556', name: 'Modify Auth Process' },
      { id: 'T1111', name: 'Multi-Factor Auth Interception' },
      ...
      { id: 'T1649', name: 'Steal or Forge Auth Certificates' },
      ...
      { id: 'T1558.005', name: 'Ccache Files' },
      ...
      { id: 'T1552.003', name: 'Shell History' },
  ...
  },
  {
    ...
    techniques: [
      ...
      { id: 'T1613', name: 'Container & Resource Discovery' },
      { id: 'T1622', name: 'Debugger Evasion' },
      ...
      { id: 'T1680', name: 'Local Storage Discovery' },
  ...
  },
  {
    ...
    techniques: [
      ...
      { id: 'T1021.003', name: 'Distributed COM' },
  ...
  },
  {
    ...
    techniques: [
      ...
      { id: 'T1602', name: 'Data from Config Repository' },
      { id: 'T1602.001', name: 'SNMP (MIB Dump)' },
      { id: 'T1602.002', name: 'Network Device Config Dump' },
      ...
      { id: 'T1213.005', name: 'Messaging Applications' },
      { id: 'T1213.006', name: 'Databases' },
  ...
  },
  {
    ...
    techniques: [
      ...
      { id: 'T1071.005', name: 'Publish/Subscribe Protocols' },
      ...
      { id: 'T1219.001', name: 'IDE Tunneling' },
      { id: 'T1219.002', name: 'Remote Desktop Software' },
      { id: 'T1219.003', name: 'Remote Access Hardware' },
      { id: 'T1205', name: 'Traffic Signaling' },
      { id: 'T1205.001', name: 'Port Knocking' },
      { id: 'T1205.002', name: 'Socket Filters' },
  ...
  },
  {
    ...
    techniques: [
      ...
      { id: 'T1048.001', name: 'Symmetric Encrypted Non-C2 Protocol' },
      { id: 'T1048.002', name: 'Asymmetric Encrypted Non-C2 Protocol' },
      { id: 'T1048.003', name: 'Unencrypted Non-C2 Protocol' },
  ...
  },
  {
    ...
    techniques: [
      ...
      { id: 'T1496.002', name: 'Bandwidth Hijacking' },
      { id: 'T1496.003', name: 'SMS Pumping' },
      { id: 'T1496.004', name: 'Cloud Service Hijacking' },
